inherited frmAdminProg: TfrmAdminProg
  ...
  Top = 238
  Height = 466
  Caption = #1040#1076#1084#1080#1085#1080#1089#1090#1088#1080#1088#1086#1074#1072#1085#1080#1077' '#1087#1088#1086#1075#1088#1072#1084#1084#1099
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited fibdsMainList: TpFIBDataSet
    SelectSQL.Strings = (
      'select PG.ID, PG.PARENT_ID, PG.GROUP_NAME, PG.ROLE_NAME,'
        ...
        'LE_NAME)) ROLE_COUNT,'
      'PG.COMMENTS'
      'from PROGRAM_GROUPS PG'
      '@WHERE'
      'order by 3')
    AutoUpdateOptions.UpdateTableName = 'PROGRAM_GROUPS'
    AutoUpdateOptions.KeyFields = 'ID'
    AutoUpdateOptions.GeneratorName = 'GEN_PROGRAM_GROUPS_ID'
  ...
  object fibdsMainRoleRights: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '   from RDB$USER_PRIVILEGES UP'
        ...
        'nd (UP.RDB$FIELD_NAME is NULL)) REFERENSE_RIGHT,'
      '0 EXECUTE_RIGHT'
      'from RDB$RELATIONS R where NOT (R.RDB$VIEW_BLR is NULL)'
      'union'
